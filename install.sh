...
copyright(){
    output "Pterodactyl Installation & Upgrade script v24.3."
...
get_virtualization(){
    ...
    if [ "$virt_serv" != "" ] && [ "$virt_serv" != "kvm" ] && [ "$virt_serv" != "vmware" ] && [ "$virt_serv" != "hyperv" ]; then
        ...
        output "No support would be given if your LXC/OpenVZ containers break at any point in the future."
        output "Proceed?\n[1] Yes.\n[2] No."
        read choice
        case $choice in 
            1)  output "Proceeding..."
